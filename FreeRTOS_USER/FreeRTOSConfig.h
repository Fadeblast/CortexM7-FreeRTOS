...
#define configUSE_TICK_HOOK						0   //1 void vApplicationTickHook( void )
...
#define configCHECK_FOR_STACK_OVERFLOW			2    //0-1-2 void vApplicationStackOverflowHook( TaskHandle_t pxTask, char *pcTaskName )
#define configUSE_RECURSIVE_MUTEXES				1
#define configUSE_MALLOC_FAILED_HOOK			0    //1 void vApplicationMallocFailedHook( void )
...
#define configUSE_CO_ROUTINES 			0     //若启用协程，启用协程以后必须添加文件croutine.c
